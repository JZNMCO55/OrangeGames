...
public:
    ...
    int                           PerimeterCount() const noexcept { return mPerimeter; }
    int                           CenterIndex() const noexcept { return mPerimeter; }
    const std::vector<glm::vec2>& Positions() const noexcept { return mPos; }
    bool                          Initialized() const noexcept { return mInit; }
